...
​
    <div style="background: #e1e4e6; padding:0 8px; width: 510px; margin: 0 auto; color: #363636; border-radius: 6px;">
        ...
        <table width="500" align="center" style="background: #fff; padding:16px; border-radius: 6px; ">
            ...
            <tr>
                <td>
                    <p style="margin: 4px 0;"><b>{{$sender}}</b> add a new comment on {{$lead}}.</p>
                  
                    <p style="margin: 4px 0 16px; padding-bottom: 8px;"><b>Comment:</b> {{$comment}}
                        </p>
            ...
            <tr>
                ...
                <a
                        ...
                        href="https://stgn.appsndevs.com/metaland/single-lead/{{$lead}}"
